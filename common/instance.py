...
class Instance:
    ...
    def __init__(self, input: Sentence, output: List[str] = None, vec: List[List] = None, type: List[List] = None, review_idx: List[List] = None, reply_idx: List[List] = None, labels_pair: List[List] = None, max_review_id: List[List] = None) -> None:
        """
